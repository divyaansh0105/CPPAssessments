...
int main()
{
    try
    {
        ...
        case 1:
        {
            string filepath = "D:/Divyaansh_Workspace/c++/Obj Reader/inputfiles/Cube10.stl";
            string filepath1 = "D:/Divyaansh_Workspace/c++/Obj Reader/outputfiles/cubeSTL.txt";
        ...
        case 2:
        {
            string filepath = "D:/Divyaansh_Workspace/c++/Obj Reader/inputfiles/cube.obj";
            string filepath1 = "D:/Divyaansh_Workspace/c++/Obj Reader/outputfiles/obj.obj";
            Triangulation triangulation;
            OBJReader objReader;
        ...
        {
            string filepath = "D:/Divyaansh_Workspace/c++/Obj Reader/inputfiles/Cube10.stl";
            string filepath1 = "D:/Divyaansh_Workspace/c++/Obj Reader/outputfiles/StlToObj.obj";
            Triangulation triangulation;
            STLReader stlReader;
            stlReader.readSTL(filepath,triangulation);
        ...
        {
            string filepath = "D:/Divyaansh_Workspace/c++/Obj Reader/inputfiles/cube.obj";
            string filepath1 = "D:/Divyaansh_Workspace/c++/Obj Reader/outputfiles/ObjToStl.stl";
            Triangulation triangulation;
            OBJReader objReader;
            objReader.readOBJ(filepath, triangulation);
